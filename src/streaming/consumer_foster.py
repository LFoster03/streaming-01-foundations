"""src/streaming/consumer_foster.py - Local consumer example.
...
Terminal command to run this file from the root project folder:
    ...
    uv run python -m streaming.consumer_foster
...
OUTPUT_CSV: Final[Path] = OUTPUT_DIR / "consumed_sales_modified.csv"
